        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Burgers_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisualPresentation = table.Column<int>(nullable: false),
                    Comment = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TasteRating", "Taste >= 0 AND Taste <= 5");
                    table.CheckConstraint("CK_TextureRating", "Texture >= 0 AND Texture <= 5");
                    table.CheckConstraint("CK_VisualPresentationRating", "VisualPresentation >= 0 AND VisualPresentation <= 5");
                    table.ForeignKey(
